...
const placesIWent = [
    ...
    {lat: 43.642664096 , lng: -79.369665188, title:'St Lawrence Market', description:'The tallest structure in Toronto, and a very special restaurant too', srcImage:'https://pedroprogrammer.com/images/photo-host/St_Lawrence_Market.PNG', altImage:'My family standing front St Lawrence Market'},
]
...
const placesIwantToGo = [
    ...
    {lat: 60.721188 , lng: -135.056839, title:'Whitehorse', description:'Because I want to see the Northern Lights', srcImage:'https://blog.venturas.com.br/wp-content/uploads/2018/08/226583-aurora-boreal-no-canada-como-acompanhar-esse-fenomeno.jpg', altImage:'Northern Lights in White Horse city'},
]
